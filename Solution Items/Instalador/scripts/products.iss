...
br.depdownload_msg=As aplicações a seguir são necessárias para o instalador continuar:%n%n%1%nFazer o download e instalar agora?



br.depdownload_memo_title=Baixar dependencias



br.depinstall_memo_title=Instalar dependencias



br.depinstall_title=Instalando dependencias



br.depinstall_description=Por favor, aguarde enquanto o Instalador instala as dependencias no seu computador.



br.depinstall_status=Instalando %1...



br.depinstall_missing=%1 faltando, precisa ser instalado antes de continuar. Por favor instale %1 e inicie o Instalador novamente.



br.depinstall_error=Um erro ocorreu enquanto instalava as dependencias. Por favor reinicie o computador e rode o Instalador novamente ou instale as seguintes dependencias manualmente:%n

br.isxdl_langfile=portugues.ini
